...
class Member(db.Model):
    ...
    nickname = db.Column(db.String(100, 'utf8mb4_0900_ai_ci'), nullable=False, server_default=db.FetchedValue(),
                         info='会员名')
    ...
    avatar = db.Column(db.String(200, 'utf8mb4_0900_ai_ci'), nullable=False, server_default=db.FetchedValue(),
                       info='会员头像')
    salt = db.Column(db.String(32, 'utf8mb4_0900_ai_ci'), nullable=False, server_default=db.FetchedValue(),
                     info='随机salt')
    reg_ip = db.Column(db.String(100, 'utf8mb4_0900_ai_ci'), nullable=False, server_default=db.FetchedValue(),
                       info='注册ip')
